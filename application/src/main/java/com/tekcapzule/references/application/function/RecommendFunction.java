...
import com.tekcapzule.references.application.function.input.RecommendInput;
import com.tekcapzule.references.application.mapper.InputOutputMapper;
import com.tekcapzule.references.domain.command.RecommendCommand;
...
public class RecommendFunction implements Function<Message<RecommendInput>, Message<Void>> {
    ...
    public RecommendFunction(final ReferenceService referenceService, final AppConfig appConfig) {
    ...
    public Message<Void> apply(Message<RecommendInput> recommendInputMessage) {
        ...
        try {
            ...
            log.info(String.format("Entering recommend reference Function -  Reference Id:%s", recommendInput.getReferenceId()));
            ...
            referenceService.recommend(recommendCommand);
